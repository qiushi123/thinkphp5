...
//请求的baseurl：http://localhost:9001/

/*
 * 轮播图banner
 * api版本区分 v1   v2
 * http://localhost:9001/api/v1/banner/1
 * http://localhost:9001/api/v2/banner/1
 * */
Route::get('api/:v/banner/:id', 'api/:v.Banner/getBanner');
/*
 * 主题专栏相关
 * http://localhost:9001/api/v1/theme/?ids=1,2,3
 * http://localhost:9001/api/v1/theme/?ids=1,2,3
 * */
...
/*
 * 商品相关
 * http://localhost:9001/api/v1/product/recent/10 获取最新10条产品
 * http://localhost:9001/api/v1/product/byCategory?id=2  获取某一个分类下所有商品
 * http://localhost:9001/api/v1/product/detail/2  获取商品详情
 * */
Route::group('api/:v/product', function () {
    Route::get('recent/:count', 'api/:v.Product/getRecent');
...
/*
 * 分类相关
 * http://localhost:9001/api/v1/category/all 获取所有de分类
 * */
Route::get('api/:v/category/all', 'api/:v.Category/getAllCategory');

/*
 * 用户相关
 * http://localhost:9001/api/v1/user/token?code='' 通过code值获取token
 * */
Route::post('api/:v/user/token', 'api/:v.User/getToken');

/*
 * 地址相关
 * http://localhost:9001/api/v1/address/add 添加或者更新地址
 * */
Route::post('api/:v/address/add', 'api/:v.Address/createOrUpdateAddress');

/*
 * 订单相关
 *http://localhost:9001/api/v1/order 订单
 *http://localhost:9001/api/v1/order/by_user  某个用户的订单
 * */
...
/*
 * 支付相关
 * http://localhost:9001/api/v1/pay/pre_order?id=2   获取预支付订单
 * http://localhost:9001/api/v1/pay/notify   支付成功后接受微信的回调
 * */
